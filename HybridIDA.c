...
u16t taxi_dist( NODE_T *pN){
   ...
   if(0){ // Linear Conflict by row TBD
      u8t *p44 = &pN->data[0];
      u8t a,b,c,d,L,R, a_, b_, c_, d_;
      L=1; R=4;
   ...
   if(0){ // Linear Conflict by column TBD
	 ...
	 a = p44[col+0]; b = p44[col+4]; c = p44[col+8]; d = p44[col+12];
	 if( a>b ) sum+=2;
	 if( b>c ) sum+=2;
	 if( c>d ) sum+=2;
	 //a_ = ( a>=1 && a<=4 );
...
[root visits: 1, depth 38]
[root visits: 2, depth 40]
[root visits: 3, depth 42]
[root visits: 4, depth 44]
...
[root visits: 1, depth 14]
[root visits: 2, depth 16]
[root visits: 3, depth 18]
[root visits: 4, depth 20]
[root visits: 5, depth 22]
[root visits: 6, depth 24]
[root visits: 7, depth 26]
